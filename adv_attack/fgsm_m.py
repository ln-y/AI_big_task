...
def save_perturbed_images(directory, fgsm_directory):
...
def task(files: List[str], directory: str, model_path: str, arr, id: int, queue):
    ...
    for filename in files:
        if filename.endswith(".jpg"):
            ...
            perturbed_image = fgsm_attack(image, epsilon, alpha, iters, model, label)
...
if __name__ == '__main__':
    save_perturbed_images(test_directory, fgsm_directory)
